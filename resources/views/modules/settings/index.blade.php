...
@section('content')
    @include('partials.breadcrumbs', ['crumbs' => [['label' => 'Configuración']]])
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="business_name" id="business_name" value="{{ old('business_name', $settings['business_name']) }}" required maxlength="150"
                        ...
                        <div>
                            ...
                            <input type="text" name="business_nit" id="business_nit" value="{{ old('business_nit', $settings['business_nit'] ?? '') }}" maxlength="20"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                            @error('business_nit') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="business_phone" class="mb-1.5 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Teléfono</label>
                            <input type="text" name="business_phone" id="business_phone" value="{{ old('business_phone', $settings['business_phone'] ?? '') }}" maxlength="20"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                            @error('business_phone') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            ...
                            <input type="email" name="business_email" id="business_email" value="{{ old('business_email', $settings['business_email'] ?? '') }}" maxlength="150"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                        ...
                        <div>
                            ...
                            <input type="text" name="business_address" id="business_address" value="{{ old('business_address', $settings['business_address'] ?? '') }}" maxlength="255"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                            @error('business_address') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="number" name="default_tax_percentage" id="default_tax_percentage" value="{{ old('default_tax_percentage', $settings['default_tax_percentage'] ?? 13.00) }}" step="0.01" min="0" max="100" required
                            ...
                            @error('default_tax_percentage') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                        </div>
                        <div>
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div>
                        ...
                        <textarea name="receipt_footer" id="receipt_footer" rows="2" maxlength="255"
                            class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">{{ old('receipt_footer', $settings['receipt_footer'] ?? '') }}</textarea>
                        @error('receipt_footer') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                    </div>
                </div>
            </div>
