...
@section('content')
    ...
    <header class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Actualiza la información de {{ $employee->full_name }}.</p>
            </div>
        </div>
        <a
    ...
    <div class="mt-6 grid items-start gap-6 lg:grid-cols-3">
        <div class="overflow-hidden rounded-2xl border border-brand-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:col-span-2">
            ...
            <form method="POST" action="{{ route('employees.update', $employee) }}" class="space-y-6 px-6 py-6 sm:px-8">
                @csrf
                @method('PUT')
