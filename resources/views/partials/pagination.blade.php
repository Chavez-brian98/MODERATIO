...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4 px-4 border-t border-brand-100 dark:border-neutral-800">
    ...
    <div class="flex items-center gap-2">
        ...
        @else
            <a href="{{ $paginator->previousPageUrl() }}" class="inline-flex items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium text-neutral-700 hover:bg-brand-100 hover:text-brand-800 transition-colors dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white" aria-label="Página anterior">
                <i class="fa-solid fa-chevron-left"></i>
            </a>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <a href="{{ $paginator->nextPageUrl() }}" class="inline-flex items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium text-neutral-700 hover:bg-brand-100 hover:text-brand-800 transition-colors dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white" aria-label="Página siguiente">
