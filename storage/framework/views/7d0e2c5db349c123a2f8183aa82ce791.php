        ...
        <header class="flex items-center justify-between gap-4 border-b border-brand-100 px-6 py-4 dark:border-neutral-800">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs text-neutral-500 dark:text-neutral-400">Categoría #<?php echo e($category->id); ?></p>
                </div>
            </div>
        ...
        <div class="overflow-y-auto px-6 py-5">
            <dl class="divide-y divide-neutral-100 dark:divide-neutral-800">
                <div class="flex items-start justify-between gap-6 py-3.5">
                    ...
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($category->description ?: 'Sin descripción'); ?></dd>
                </div>
                ...
                <div class="flex items-center justify-between gap-6 py-3.5">
                    ...
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($category->parent?->name ?? 'Sin categoría padre'); ?></dd>
                </div>

                <div class="flex items-center justify-between gap-6 py-3.5">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Subcategorías</dt>
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($category->children_count); ?></dd>
                </div>
                ...
                <div class="flex items-center justify-between gap-6 py-3.5">
                    ...
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($category->created_at->format('d/m/Y')); ?></dd>
                </div>
            </dl>
        </div>
...
<?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views\modules\categories\show.blade.php ENDPATH**/ ?>