            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody id="cash-register-tbody" class="divide-y divide-neutral-100 dark:divide-neutral-800">
                    <?php $__empty_1 = true; $__currentLoopData = $registers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $register): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="transition-colors hover:bg-brand-50/40 dark:hover:bg-neutral-800/40" data-search="<?php echo e(strtolower($register->id . ' ' . ($register->shift ?? '') . ' ' . $register->user->full_name)); ?>">
                            <td class="px-4 py-3 font-medium text-neutral-800 dark:text-neutral-200">#<?php echo e($register->id); ?></td>
                            <td class="px-4 py-3 text-neutral-600 dark:text-neutral-400"><?php echo e($register->shift ?? '—'); ?></td>
                            ...
                            <td class="px-4 py-3">
                                <a href="<?php echo e(route('cash-register.show', $register)); ?>" class="inline-flex items-center gap-1.5 rounded-lg bg-brand-50 px-3 py-1.5 text-xs font-medium text-brand-700 transition-colors hover:bg-brand-100 dark:bg-brand-900/20 dark:text-brand-300 dark:hover:bg-brand-900/40">
