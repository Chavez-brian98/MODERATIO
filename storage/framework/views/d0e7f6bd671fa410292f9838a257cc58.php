        ...
        <header class="flex items-center justify-between gap-4 border-b border-brand-100 px-6 py-4 dark:border-neutral-800">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs text-neutral-500 dark:text-neutral-400"><?php echo e($log->created_at->format('d/m/Y \a\s H:i:s')); ?></p>
                </div>
            </div>
        ...
        <div class="overflow-y-auto px-6 py-5">
            ...
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                ...
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    ...
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($tableLabels[$log->affected_table] ?? $log->affected_table); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">ID del registro</dt>
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($log->record_id ? '#' . $log->record_id : '—'); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Dirección IP</dt>
                    <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($log->source_ip ?? '—'); ?></dd>
                </div>
            </dl>
            ...
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    ...
                    <dd class="text-sm font-medium text-neutral-900 dark:text-white"><?php echo e($log->user?->full_name ?? 'Sistema'); ?></dd>
                </div>
                <?php if($log->user): ?>
                    <div class="flex items-center justify-between gap-6 px-4 py-3">
                        <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Correo</dt>
                        <dd class="text-sm text-neutral-900 dark:text-white"><?php echo e($log->user->email); ?></dd>
                    </div>
                <?php endif; ?>
            </dl>
            ...
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    ...
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($log->created_at->format('d/m/Y \a\s H:i:s')); ?></dd>
                </div>
            </dl>
        </div>
...
<?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/audit/show.blade.php ENDPATH**/ ?>