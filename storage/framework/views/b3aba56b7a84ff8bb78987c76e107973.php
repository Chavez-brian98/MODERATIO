    ...
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cash_registers_edit')): ?>
                <form method="POST" action="<?php echo e(route('cash-register.toggle-status', $register)); ?>" data-swal-confirm="<?php echo e($isClosed ? 'La caja fue cerrada previamente. ¿Estás seguro de que deseas abrirla de nuevo?' : 'La caja se marcará como cerrada.'); ?>" data-swal-confirm-title="<?php echo e($isClosed ? '¿Reabrir caja?' : '¿Cerrar caja?'); ?>" data-swal-confirm-icon="<?php echo e($isClosed ? 'warning' : 'question'); ?>" data-swal-confirm-button="<?php echo e($isClosed ? 'Sí, reabrir' : 'Sí, cerrar'); ?>" data-swal-confirm-color="<?php echo e($isClosed ? 'warning' : 'brand'); ?>">
                    <?php echo csrf_field(); ?>
