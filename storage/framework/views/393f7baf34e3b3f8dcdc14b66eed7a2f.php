<?php $__env->startSection('title', 'Nuevo empleado · ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mt-6 grid items-start gap-6 lg:grid-cols-3">
        <div class="overflow-hidden rounded-2xl border border-brand-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:col-span-2">
            ...
            <form method="POST" action="<?php echo e(route('employees.store')); ?>" class="space-y-6 px-6 py-6 sm:px-8">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/employees/create.blade.php ENDPATH**/ ?>