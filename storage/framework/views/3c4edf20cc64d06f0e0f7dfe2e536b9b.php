...
<div class="group lg:grid lg:grid-cols-[17rem_1fr] transition-[grid-template-columns] duration-300 lg:has-checked:grid-cols-[4.5rem_1fr]">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 flex w-72 max-w-[85vw] -translate-x-full flex-col overflow-y-auto border-r border-brand-200 bg-white p-4 shadow-xl transition-transform duration-300 group-has-checked:translate-x-0 lg:bottom-auto lg:left-auto lg:z-auto lg:w-full lg:max-w-none lg:translate-x-0 lg:overflow-visible lg:shadow-none lg:sticky lg:top-0 lg:h-screen lg:p-5 lg:group-has-checked:min-w-0 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div class="flex justify-center px-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="block lg:group-has-checked:hidden">
                <img src="<?php echo e(asset('storage/logobg.png')); ?>" alt="Glenda Store" class="mx-auto h-16 w-auto max-w-full object-contain sm:h-20 lg:h-24"/>
            </a>
        </div>
        ...
        <nav class="mt-2 flex-1 space-y-1 lg:overflow-x-hidden lg:overflow-y-auto lg:group-has-checked:overflow-hidden">
            <?php
                $sections = [
                    [
                        'title' => 'General',
                        'items' => [
                            ['route' => 'dashboard', 'label' => 'Dashboard', 'icon' => 'fa fa-line-chart'],
                        ],
                    ],
                    [
                        'title' => 'Punto de Venta',
                        'items' => [
                            ['route' => 'pos', 'label' => 'POS', 'path' => 'M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z'],
                            ['route' => 'cash-register.index', 'label' => 'Caja / Arqueo', 'path' => 'M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                        ],
                    ],
                    [
                        'title' => 'Inventario',
                        'items' => [
                            ['route' => 'inventory.index', 'label' => 'Inventario', 'path' => 'M21 7.5l-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9'],
                            ['route' => 'categories.index', 'label' => 'Categorías', 'path' => 'M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3ZM6 6h.008v.008H6V6Z'],
                        ],
                    ],
                    [
                        'title' => 'Seguridad',
                        'items' => [
                            ...
                            ['route' => 'roles.index', 'label' => 'Roles y Permisos', 'path' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z'],
                            ['route' => 'audit.index', 'label' => 'Bitácora (Auditoría)', 'path' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z'],
                        ],
                    ],
                    [
                        'title' => 'Post-Venta',
                        'items' => [
                            ['route' => 'returns.index', 'label' => 'Devoluciones / Notas de Crédito', 'path' => 'M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3'],
                        ],
                    ],
                    [
                        'title' => 'Analítica',
                        'items' => [
                            ['route' => 'reports.index', 'label' => 'Reportes', 'path' => 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z'],
                        ],
                    ],
                    [
                        'title' => 'Configuración',
            ...
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p class="mt-5 px-2 text-xs font-semibold uppercase tracking-wider text-brand-500 lg:group-has-checked:hidden dark:text-brand-400"><?php echo e($section['title']); ?></p>
                <div class="mt-1.5 space-y-1">
                    <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                        ...
                        >
                            ...
                            <?php endif; ?>
                            <span class="lg:group-has-checked:hidden"><?php echo e($module['label']); ?></span>
                        </a>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-2 border-t border-brand-100 pt-4 dark:border-neutral-800">
            <?php echo csrf_field(); ?>
            <button
                type="submit"
                class="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-neutral-600 transition-colors hover:bg-brand-100 hover:text-brand-800 lg:group-has-checked:justify-center lg:group-has-checked:px-0 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-white"
            >
                <svg class="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9" class="stroke-current" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <span class="lg:group-has-checked:hidden">Cerrar sesión</span>
            </button>
        </form>
    </aside>
