...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400"><?php echo e($product->name); ?></p>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('inventory.update', $product)); ?>">
        <?php echo csrf_field(); ?>
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name', $product->name)); ?>" required maxlength="150"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="barcode" id="barcode" value="<?php echo e(old('barcode', $product->barcode)); ?>" maxlength="50"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200"><?php echo e(old('description', $product->description)); ?></textarea>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="purchase_price" id="purchase_price" value="<?php echo e(old('purchase_price', number_format($product->purchase_price, 2, '.', ''))); ?>" step="0.01" min="0" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400">$</span>
                                <input type="number" name="sale_price" id="sale_price" value="<?php echo e(old('sale_price', number_format($product->sale_price, 2, '.', ''))); ?>" step="0.01" min="0" required
                                    class="w-full rounded-xl border border-brand-200 bg-white py-2.5 pl-8 pr-4 text-sm text-neutral-700 shadow-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                            </div>
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="number" name="current_stock" id="current_stock" value="<?php echo e(old('current_stock', $product->current_stock)); ?>" min="0" required
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="min_stock" id="min_stock" value="<?php echo e(old('min_stock', $product->min_stock)); ?>" min="0" required
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <label class="relative inline-flex cursor-pointer items-center">
                                <input type="checkbox" name="has_tax" id="has_tax" value="1" <?php echo e(old('has_tax', $product->has_tax ? '1' : '0') === '1' ? 'checked' : ''); ?> class="peer sr-only" onchange="document.getElementById('tax_percentage_group').style.display = this.checked ? '' : 'none'" />
                        ...
                        <div id="tax_percentage_group" style="<?php echo e(old('has_tax', $product->has_tax ? '1' : '0') !== '1' ? 'display:none' : ''); ?>">
                            ...
                            <input type="number" name="tax_percentage" id="tax_percentage" value="<?php echo e(old('tax_percentage', $product->tax_percentage)); ?>" step="0.01" min="0" max="100"
                                class="w-full rounded-xl border border-brand-200 bg-white py-2.5 px-4 text-sm text-neutral-700 shadow-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" />
                ...
                <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="mt-3 space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span id="summary-purchase" class="font-medium text-neutral-800 dark:text-neutral-200">$<?php echo e(number_format($product->purchase_price, 2)); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-neutral-500 dark:text-neutral-400">Precio venta:</span>
                            <span id="summary-sale" class="font-medium text-neutral-800 dark:text-neutral-200">$<?php echo e(number_format($product->sale_price, 2)); ?></span>
                        </div>
                        <div class="flex justify-between border-t border-brand-100 pt-2 dark:border-neutral-700">
                            ...
                            <span id="summary-margin" class="font-semibold text-emerald-600 dark:text-emerald-400">$<?php echo e(number_format($product->sale_price - $product->purchase_price, 2)); ?></span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views\modules\inventory\edit.blade.php ENDPATH**/ ?>