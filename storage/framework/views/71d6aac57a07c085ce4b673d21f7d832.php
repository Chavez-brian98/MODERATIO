...
>
    ...
    >
        ...
        <form
            ...
            data-permissions-mode="<?php echo e($matrixMode); ?>"
        ...
        >
            ...
            <div class="overflow-y-auto px-6 py-5">
                <?php if($superToggleChecked !== null): ?>
                    <div class="flex items-center justify-between gap-4 rounded-xl border px-4 py-3.5 <?php echo e($superToggleChecked ? 'border-violet-300 bg-violet-50/60 dark:border-violet-800 dark:bg-violet-900/20' : 'border-brand-200 bg-brand-50/40 dark:border-neutral-800 dark:bg-neutral-800/40'); ?>">
                        <div>
                        ...
                        <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                            <input
                                ...
                                <?php if($superToggleChecked): echo 'checked'; endif; ?>
                                class="peer sr-only"
                            />
                ...
                <?php if($lockedHint !== null || $superToggleChecked !== null): ?>
                    <p
                        data-permissions-locked-hint
                        class="mt-4 flex items-center gap-2 rounded-lg bg-violet-50 px-3 py-2 text-xs font-medium text-violet-700 dark:bg-violet-900/30 dark:text-violet-300 <?php echo e(($lockedMatrix || $superToggleChecked) ? '' : 'hidden'); ?>"
                    >
                        <i class="fa-solid fa-lock text-[10px]" aria-hidden="true"></i>
                        <?php echo e($lockedHint ?? 'Acceso total activo: todos los permisos están marcados y bloqueados.'); ?>
                ...
                <div
                    ...
                    data-inherited="<?php echo e(json_encode(array_values($matrixInheritedIds))); ?>"
                    class="mt-5 <?php echo e(($lockedMatrix || $superToggleChecked) ? 'opacity-40' : ''); ?>"
                >
                                    ...
                                    <tr class="hover:bg-brand-50/30 dark:hover:bg-neutral-800/40">
                                        ...
                                        <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td class="px-4 py-2.5 text-center">
                                                <?php if($permission): ?>
                                                    <?php if($matrixMode === 'ids'): ?>
                                                        <input
                                                            type="checkbox"
                                                            name="permissions[]"
                                                            value="<?php echo e($permission->id); ?>"
                                                            <?php if($matrixStates[$permission->id] ?? false): echo 'checked'; endif; ?>
                                                            <?php if($lockedMatrix || $superToggleChecked): echo 'disabled'; endif; ?>
...
<?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/shared/partials/permissions-modal.blade.php ENDPATH**/ ?>