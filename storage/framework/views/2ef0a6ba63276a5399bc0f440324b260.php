<?php $__env->startSection('title', 'Editar empleado · ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <header class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-neutral-900 dark:text-white">Editar empleado</h1>
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Actualiza la información de <?php echo e($employee->full_name); ?>.</p>
            </div>
        </div>
        <a
    ...
    <div class="mt-6 grid items-start gap-6 lg:grid-cols-3">
        <div class="overflow-hidden rounded-2xl border border-brand-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:col-span-2">
            ...
            <form method="POST" action="<?php echo e(route('employees.update', $employee)); ?>" class="space-y-6 px-6 py-6 sm:px-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            name="full_name"
                            type="text"
                            value="<?php echo e(old('full_name', $employee->full_name)); ?>"
                            required
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input
                                ...
                                name="DUI"
                                type="text"
                                value="<?php echo e(old('DUI', $employee->DUI)); ?>"
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            name="birthday"
                            type="date"
                            value="<?php echo e(old('birthday', $employee->birthday?->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="mt-1 block w-full rounded-lg border border-neutral-300 bg-white px-3.5 py-2.5 text-sm text-neutral-900 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white dark:placeholder:text-neutral-500"
                        />
                        <p class="mt-1.5 text-xs text-neutral-400 dark:text-neutral-500">Solo completa este campo si vas a cambiar la contraseña.</p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <aside class="space-y-6">
            <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400"><?php echo e($roles->count()); ?> <?php echo e($roles->count() === 1 ? 'rol definido' : 'roles definidos'); ?> en el sistema.</p>
                    ...
                    <ul class="mt-4 space-y-3">
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-start gap-3 text-sm">
                                ...
                                <span class="min-w-0">
                                    <span class="block font-medium text-neutral-800 dark:text-neutral-200"><?php echo e($roleLabels[$role->name] ?? $role->name); ?></span>
                                    <?php if($role->description): ?>
                                        <span class="block text-xs text-neutral-500 dark:text-neutral-400"><?php echo e($role->description); ?></span>
                                    <?php endif; ?>
                                </span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="rounded-2xl border border-brand-200 bg-brand-50/60 p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-800/40">
                ...
                <ul class="mt-4 space-y-3 text-sm text-neutral-600 dark:text-neutral-400">
                    <li class="flex gap-2.5">
                        ...
                        Cambiar el nombre no afecta a las ventas existentes.
                    </li>
                    <li class="flex gap-2.5">
                        <i class="fa-solid fa-circle-check mt-0.5 text-brand-600 dark:text-brand-400" aria-hidden="true"></i>
                        Para reactivar un empleado, usa este formulario y guarda los cambios.
                    </li>
                    <li class="flex gap-2.5">
                        <i class="fa-solid fa-circle-check mt-0.5 text-brand-600 dark:text-brand-400" aria-hidden="true"></i>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/employees/edit.blade.php ENDPATH**/ ?>