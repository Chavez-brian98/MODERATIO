<?php $__env->startSection('title', 'Editar cliente · ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <header class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400"><?php echo e($customer->first_name); ?> <?php echo e($customer->last_name); ?></p>
            </div>
        </div>
        <a
    ...
    <div class="mt-6 grid items-start gap-6 lg:grid-cols-3">
        <div class="overflow-hidden rounded-2xl border border-brand-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:col-span-2">
            ...
            <form method="POST" action="<?php echo e(route('customers.update', $customer)); ?>" class="space-y-6 px-6 py-6 sm:px-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="tax_id"
                            type="text"
                            value="<?php echo e(old('tax_id', $customer->tax_id)); ?>"
                            maxlength="20"
                            class="mt-1 block w-full rounded-lg border border-neutral-300 bg-white px-3.5 py-2.5 text-sm text-neutral-900 shadow-sm placeholder:text-neutral-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white dark:placeholder:text-neutral-500"
                        />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between gap-4 rounded-xl border border-brand-200 bg-brand-50/40 px-4 py-3.5 dark:border-neutral-800 dark:bg-neutral-800/40">
                    ...
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input type="checkbox" name="is_active" value="1" <?php if(old('is_active', $customer->is_active)): echo 'checked'; endif; ?> class="peer sr-only" />
        ...
        <aside class="space-y-6">
            <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <p class="text-2xl font-bold text-neutral-900 dark:text-white"><?php echo e($customer->sales_count ?? $customer->sales()->count()); ?></p>
                <p class="mt-1 text-xs text-neutral-400 dark:text-neutral-500">Cliente desde el <?php echo e($customer->created_at->format('d/m/Y')); ?>.</p>
            </div>
        </aside>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views\modules\customers\edit.blade.php ENDPATH**/ ?>