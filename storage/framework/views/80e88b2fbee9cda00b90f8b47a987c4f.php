<?php $__env->startSection('title', 'Devolución #' . $return->id); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-brand-800 sm:text-3xl dark:text-brand-200">Devolución #<?php echo e($return->id); ?></h1>
            <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                Venta <?php echo e($return->sale->ticket_number); ?> — <?php echo e($return->created_at->format('d/m/Y H:i')); ?>
    ...
    <div class="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <p class="mt-1 text-2xl font-bold text-red-600 dark:text-red-400">$<?php echo e(number_format($return->total_returned, 2)); ?></p>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <p class="text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Productos</p>
            <p class="mt-1 text-2xl font-bold text-neutral-800 dark:text-neutral-100"><?php echo e($return->details->count()); ?></p>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <p class="text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Empleado</p>
            <p class="mt-1 text-sm font-semibold text-neutral-800 dark:text-neutral-100"><?php echo e($return->user->full_name); ?></p>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <p class="text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Fecha</p>
            <p class="mt-1 text-sm font-semibold text-neutral-800 dark:text-neutral-100"><?php echo e($return->created_at->format('d/m/Y H:i:s')); ?></p>
        </div>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                            <?php $__empty_1 = true; $__currentLoopData = $return->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="transition-colors hover:bg-brand-50/40 dark:hover:bg-neutral-800/40">
                                    <td class="px-4 py-3 font-medium text-neutral-800 dark:text-neutral-200"><?php echo e($detail->product->name ?? 'Producto #' . $detail->product_id); ?></td>
                                    <td class="px-4 py-3 dark:text-neutral-300"><?php echo e($detail->quantity); ?></td>
                                    <td class="px-4 py-3 font-semibold text-red-600 dark:text-red-400">-$<?php echo e(number_format($detail->subtotal_returned, 2)); ?></td>
                                </tr>
        ...
        <div class="space-y-6">
            <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <p class="text-sm text-neutral-700 dark:text-neutral-300"><?php echo e($return->reason); ?></p>
            </div>
            ...
            <div class="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <dl class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <dd class="font-medium text-neutral-800 dark:text-neutral-200"><?php echo e($return->sale->ticket_number); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-neutral-500 dark:text-neutral-400">Total venta:</dt>
                        <dd class="font-medium text-neutral-800 dark:text-neutral-200">$<?php echo e(number_format($return->sale->total, 2)); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-neutral-500 dark:text-neutral-400">Método pago:</dt>
                        <dd class="text-neutral-800 dark:text-neutral-200"><?php echo e($return->sale->payment_method); ?></dd>
                    </div>
                </dl>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views\modules\returns\show.blade.php ENDPATH**/ ?>