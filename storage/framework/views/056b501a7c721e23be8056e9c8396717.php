<?php $__env->startSection('title', 'Devoluciones / Notas de Crédito'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.breadcrumbs', ['crumbs' => [['label' => 'Devoluciones / Notas de Crédito']]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-neutral-800 dark:text-neutral-100"><?php echo e($stats['total_returns']); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-neutral-800 dark:text-neutral-100">$<?php echo e(number_format($stats['total_refunded'], 2)); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-neutral-800 dark:text-neutral-100"><?php echo e($stats['today_returns']); ?></p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-neutral-800 dark:text-neutral-100">$<?php echo e(number_format($stats['today_refunded'], 2)); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody id="returns-tbody" class="divide-y divide-neutral-100 dark:divide-neutral-800">
                    <?php $__empty_1 = true; $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="transition-colors hover:bg-brand-50/40 dark:hover:bg-neutral-800/40"
                            ...
                            <td class="hidden px-4 py-3 md:table-cell dark:text-neutral-300"><?php echo e($return->user->full_name); ?></td>
