<div
    ...
    data-permissions-url="<?php echo e(route('roles.permissions.sync', $role)); ?>"
    role="dialog"
    aria-modal="true"
...
>
    ...
    >
            ...
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    <h2 id="role-permissions-modal-title" class="truncate text-lg font-semibold text-neutral-900 dark:text-white">
                        Permisos · <?php echo e($role->name); ?>

                    </h2>
                    <p class="text-xs text-neutral-500 dark:text-neutral-400">Marca las acciones que este rol puede realizar.</p>
                </div>
            </div>
        ...
        <form data-permissions-form action="<?php echo e(route('roles.permissions.sync', $role)); ?>" class="flex min-h-0 flex-1 flex-col">
            <?php echo csrf_field(); ?>

            <div class="overflow-y-auto px-6 py-5">
                <div class="flex items-center justify-between gap-4 rounded-xl border px-4 py-3.5 <?php echo e($role->is_super_admin ? 'border-violet-300 bg-violet-50/60 dark:border-violet-800 dark:bg-violet-900/20' : 'border-brand-200 bg-brand-50/40 dark:border-neutral-800 dark:bg-neutral-800/40'); ?>">
                    <div>
                    ...
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input
                            ...
                            <?php if($role->is_super_admin): echo 'checked'; endif; ?>
                            class="peer sr-only"
                        />
                ...
                <p
                    ...
                    class="mt-4 flex items-center gap-2 rounded-lg bg-violet-50 px-3 py-2 text-xs font-medium text-violet-700 dark:bg-violet-900/30 dark:text-violet-300 <?php echo e($role->is_super_admin ? '' : 'hidden'); ?>"
                >
                    <i class="fa-solid fa-lock text-[10px]" aria-hidden="true"></i>
                    Acceso total activo: todos los permisos están marcados y bloqueados.
                </p>

                <div data-permissions-matrix class="mt-5 <?php echo e($role->is_super_admin ? 'opacity-40' : ''); ?>">
                            ...
                            <thead>
                                <tr class="bg-brand-50/60 text-left text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:bg-neutral-800/60 dark:text-neutral-400">
                                    ...
                                    <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th class="px-4 py-3 text-center"><?php echo e($action->display_name); ?></th>
                                ...
                                <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-brand-50/30 dark:hover:bg-neutral-800/40">
                                        <td class="px-4 py-2.5 font-medium text-neutral-800 dark:text-neutral-200">
                                            <?php echo e($resource->display_name); ?>
                                            ...
                                            <td class="px-4 py-2.5 text-center">
                                                <?php if($permission): ?>
                                                    <input
                                                        ...
                                                        <?php if($role->is_super_admin || in_array($permission->id, $rolePermissionIds)): echo 'checked'; endif; ?>
                                                        <?php if($role->is_super_admin): echo 'disabled'; endif; ?>
                                                        title="<?php echo e($permission->display_name); ?>"
...
<?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/roles/partials/permissions.blade.php ENDPATH**/ ?>