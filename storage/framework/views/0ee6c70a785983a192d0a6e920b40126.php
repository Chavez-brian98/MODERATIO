    ...
    >
        <header class="flex items-center justify-between gap-4 border-b border-brand-100 px-6 py-4 dark:border-neutral-800">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    <h2 id="employee-modal-title" class="truncate text-lg font-semibold text-neutral-900 dark:text-white">
                        <?php echo e($employee->full_name); ?>

                    </h2>
                    <p class="text-xs text-neutral-500 dark:text-neutral-400">Empleado #<?php echo e($employee->id); ?></p>
                </div>
            </div>
        ...
        <?php
            ...
            $age = $employee->birthday ? $employee->birthday->diffInYears(now()) : null;
        ?>
        ...
        <div class="overflow-y-auto px-6 py-5">
            ...
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Nombre completo</dt>
                    <dd class="text-right text-sm font-medium text-neutral-900 dark:text-white"><?php echo e($employee->full_name); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Correo electrónico</dt>
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($employee->email); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Dirección</dt>
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($employee->address ?: '—'); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">DUI</dt>
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($employee->DUI ?: '—'); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Fecha de nacimiento</dt>
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($employee->birthday?->format('d/m/Y') ?: '—'); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    <dt class="shrink-0 text-sm text-neutral-500 dark:text-neutral-400">Edad</dt>
                    <dd class="text-right text-sm text-neutral-900 dark:text-white"><?php echo e($age !== null ? $age . ' años' : '—'); ?></dd>
                </div>
            </dl>
            ...
            <h3 class="mb-3 mt-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-neutral-400 dark:text-neutral-500">
                <i class="fa-solid fa-briefcase text-sm" aria-hidden="true"></i>
                Datos laborales
            </h3>
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                <div class="flex items-center justify-between gap-6 px-4 py-3">
            ...
            <dl class="divide-y divide-neutral-100 rounded-xl border border-neutral-100 dark:divide-neutral-800 dark:border-neutral-800">
                <div class="flex items-center justify-between gap-6 px-4 py-3">
                    ...
                    <dd class="text-right text-sm text-neutral-900 dark:text-white">#<?php echo e($employee->id); ?></dd>
                </div>
                <div class="flex items-center justify-between gap-6 px-4 py-3">
...
<?php /**PATH C:\Users\Brian\PhpstormProjects\Glenda_Store\resources\views/modules/employees/show.blade.php ENDPATH**/ ?>